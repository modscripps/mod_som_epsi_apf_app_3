...
#define MOD_SOM_EFE_OBP_DEFAULT_NFFT            2048
...
#define MOD_SOM_EFE_OPB_STATUS_FAIL_TO_START_FILL_SEGMENT_TASK      0x17u
#define MOD_SOM_EFE_OPB_STATUS_FAIL_TO_START_CPT_SPECTRA_TASK       0x18u
#define MOD_SOM_EFE_OPB_STATUS_FAIL_TO_START_CPT_DISSRATE_TASK      0x19u
