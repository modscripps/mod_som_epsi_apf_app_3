/*******************************************************************************
 * @file mod_som_obp.h
 * @brief MOD SOM on board processing command shell API Implementation
 * @date March 01, 2021
...
//------------------------------------------------------------------------------
/* @var mod_som_obp_cmd_tbl predefined command table of fixed size        */
static SHELL_CMD  mod_som_obp_cmd_tbl[] =
{
    { "efeobp.start",   mod_som_efe_obp_cmd_start_f},
    { "efeobp.stop",    mod_som_efe_obp_cmd_stop_f},
...
/*******************************************************************************
 * @brief
 *   Initialize OBP, command shell
 *
 * @return
 *   MOD_SOM_STATUS_OK if initialization goes well
 *   or otherwise
 ******************************************************************************/
mod_som_status_t mod_som_efe_obp_init_cmd_f(){
    RTOS_ERR err;
    Shell_CmdTblAdd("EOBP CMDs", mod_som_obp_cmd_tbl, &err);
    if(RTOS_ERR_CODE_GET(err) != RTOS_ERR_NONE){
        return mod_som_efe_obp_encode_status_f(MOD_SOM_EFE_OBP_STATUS_FAIL_TO_ADD_CMD_TBL);
    }
 ...
 ******************************************************************************/
CPU_INT16S mod_som_efe_obp_cmd_start_f(CPU_INT16U argc,
        CPU_CHAR *argv[],
 ...
 *   Micrium Command Shell Status
 ******************************************************************************/
CPU_INT16S mod_som_efe_obp_cmd_stop_f(CPU_INT16U argc,
        CPU_CHAR *argv[],
        SHELL_OUT_FNCT out_put_f,
        SHELL_CMD_PARAM *cmd_param){
    mod_som_status_t status = 0;
...
CPU_INT16S mod_som_efe_obp_cmd_channel_f(CPU_INT16U argc,
    ...
    mod_som_efe_obp_consumer_channel_f(argc,argv);
 ...
 *   Micrium Command Shell Status
 ******************************************************************************/
CPU_INT16S mod_som_efe_obp_cmd_mode_f(CPU_INT16U argc,
        CPU_CHAR *argv[],
        SHELL_OUT_FNCT out_put_f,
        SHELL_CMD_PARAM *cmd_param){
    mod_som_status_t status = 0;
 ...
 *   Micrium Command Shell Status
 ******************************************************************************/
CPU_INT16S mod_som_efe_obp_cmd_init_f(CPU_INT16U argc,
        CPU_CHAR *argv[],
        SHELL_OUT_FNCT out_put_f,
        SHELL_CMD_PARAM *cmd_param){
    mod_som_status_t status = 0;
